...
OhdsiRTools::checkUsagePackage("warfarinBleeding")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/warfarinBleeding.pdf")
shell("R CMD Rd2pdf ./ --output=extras/warfarinBleeding.pdf")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("warfarinBleeding")
