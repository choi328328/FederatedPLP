...
Vignette: [Using the package skeleton for patient-level prediction studies](https://raw.githubusercontent.com/OHDSI/StudyProtocolSandbox/master/BipolarMisclassification/inst/doc/UsingSkeletonPackage.pdf)
...
```r
  library(BipolarMisclassification)
  # USER INPUTS
#=======================
# The folder where the study intermediate and result files will be written:
outputFolder <- "./BipolarMisclassificationResults"
...
cohortTable <- 'BipolarMisclassificationCohort'
#=======================
...
```r
  ...
  devtools::install_github("OHDSI/StudyProtocolSandbox/BipolarMisclassification")
```
