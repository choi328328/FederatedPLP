...
OhdsiRTools::checkUsagePackage("BipolarMisclassification")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/BipolarMisclassification.pdf")
shell("R CMD Rd2pdf ./ --output=extras/BipolarMisclassification.pdf")
...
OhdsiRTools::insertCohortDefinitionSetInPackage(fileName = "CohortsToCreate.csv",
                                                ...
                                                generateStats = FALSE,
                                                packageName = "BipolarMisclassification")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("BipolarMisclassification")
